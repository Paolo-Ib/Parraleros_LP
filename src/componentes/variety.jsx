  ...
  return (
    <>
      <section className="py-12 px-12 border rounded-lg text-justify">
        <h2 className="text-3xl font-semibold mb-4 text-center"><b>Parral de Sombra</b> - Características</h2>
      ...
      <section className="py-12 px-8 grid grid-cols-2 gap-2">
        ...
        <div className="p-4 border rounded-lg text-left bg-white">
          <h3 className="text-xl font-bold text-center">Linea Clasica</h3>
        ...
        <div className="p-4 border rounded-lg text-left bg-white">
          <h3 className="text-xl font-bold text-center">Linea Premium</h3>
